...
declare
	file_id_v ALIAS FOR $1;
	line_no_v ALIAS FOR $2;
	column_start_v ALIAS FOR $3;
	res			     int;
begin
	select correlation_id into res from reports r where r.file_id=file_id_v and r.line_no=line_no_v and r.column_start=column_start_v;
